...
//     var_dump(count($datas));
            ...
            <ul> 
                <li><a href="/espace-admin/messages/<?php echo $_SESSION['id_admin'];?>" <?php if($count>0):?> class="notification" data-notification="<?php echo $count;?>" <?php endif;?>>Messages</a> </li>
               <li> <a href="/espace-admin/profile">Accueil</a> </li> 
...
//     var_dump($message[$i]->getUser1());
    ...
    <div class="read"><a href="/espace-admin/voir-message/<?php echo $message[$i]->getId() ?>">Voir</a></div>
    <tr>
