...
--><div class="content">
     ...
     var_dump(count($datas['message']));
            ...
            <ul> 
               ...
               <li> <a href="/espace-administration">Espace administration</a> </li> </ul>
        </div>
        <?php 
           ?>
...
<section>
    <article>
        <h4>Repondre</h4>
        <p>
            <form method="POST" action="/espace-admin/creation-messsage">
    <p>
       
<input type='hidden' name='id_admin' class='pass_word' value="<?php echo $_SESSION['id_admin'] ?>">
    </p>
    <p>
