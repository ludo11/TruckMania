...
//     var_dump(count($datas['message']));
            ...
            <ul> 
                <li><a href="/espace-pros/messages/<?php echo $_SESSION['id_pro'];?>">Retour</a> </li>
               <li> <a href="/espace-pros/profile">Accueil</a> </li> </ul>
        </div>
        <?php 
           ?>
...
<section>
    <article>
        <h4>Repondre</h4>
        <p>
            <form method="POST" action="/espace-pros/creation-messsage">
    <p>
       
<input type='hidden' name='id_pro' class='pass_word' value="<?php echo $_SESSION['id_pro'] ?>">
    </p>
    <p>
